    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground font-body" dir="rtl">
      ...
      <main className="flex-1">
        ...
        <section id="pricing" className="w-full py-20 bg-white">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
              <h2 className="text-3xl md:text-4xl font-bold font-headline">باقات تناسب مسيرتك</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="p-8 rounded-3xl border bg-white shadow-sm flex flex-col relative hover:border-primary/50 transition-colors">
                ...
                <ul className="space-y-4 mb-8 flex-1 text-start">
                  ...
                  <li className="flex items-center gap-3 text-sm font-tajawal text-muted-foreground">
              ...
              <div className="p-8 rounded-3xl border-2 border-primary bg-primary/5 shadow-xl flex flex-col relative transform lg:scale-105">
                ...
                <ul className="space-y-4 mb-8 flex-1 text-start">
                  ...
                  <li className="flex items-center gap-3 text-sm font-tajawal">
                    <CheckCircle2 className="h-5 w-5 text-primary" />
                    <span className="font-bold">دعم فني ذو أولوية عبر واتساب</span>
                  </li>
                  <li className="flex items-center gap-3 text-sm font-tajawal">
                    <CheckCircle2 className="h-5 w-5 text-primary" />
                    <span className="font-bold">تحميل PDF بلمسة واحدة</span>
                  </li>
                </ul>
                <Link href="/pricing">
        ...
        <section className="w-full py-20 relative overflow-hidden">
          ...
          <div className="container px-4 md:px-6 mx-auto text-center space-y-8 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Link href="/auth/sign-up">
                <Button size="lg" className="h-14 px-10 text-xl bg-white text-primary hover:bg-white/90 shadow-2xl transition-all hover:scale-105">
                  ابدأ تجربتك المجانية
                  <ChevronLeft className="ms-2 h-6 w-6" />
                </Button>
              </Link>
              <Link href="https://wa.me/213555000000">
                <Button size="lg" variant="outline" className="h-14 px-10 text-xl border-white/30 text-white hover:bg-white/10">
                  تحدث مع الدعم
                </Button>
              </Link>
            </div>
